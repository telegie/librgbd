...
CameraCalibrationType KinectCameraCalibration::getType() const noexcept
{
...
glm::vec2 KinectCameraCalibration::getUv(const glm::vec3& direction) const noexcept
{
    return compute_kinect_uv(*this, direction);
}
} // namespace rgbd
